...
const NavBar = () => {
    ...
    const handleScroll = (id: string) => {
        ...
        console.log(contactSection, id, "contactSection")
        if (contactSection) {
                    ...
                    <div className="lg:flex hidden items-center gap-20">
                        <ul className="flex items-center justify-center gap-8">
                            <List className="w-full text-base">
                                ...
                                <NavLink to={"/blogs"} className="relative inline-block overflow-hidden mr-4 cursor-pointer pt-2 pl-2 before:w-2 before:h-2 before:bg-color2 before:absolute before:top-2 before:-left-10 before:rounded-full before:transition-all before:duration-200 before:ease-in hover:before:left-0.5 after:w-0.5 after:h-3 after:bg-color2 after:absolute after:left-1 after:-top-10 hover:after:top-3.5 after:transition-all after:duration-200 after:ease-in">
                                    Blogs
                                </NavLink>
                            </List>
